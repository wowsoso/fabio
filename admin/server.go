...
import (
    ...
    "github.com/wowsoso/fabioz/admin/api"
    "github.com/wowsoso/fabioz/admin/ui"
    "github.com/wowsoso/fabioz/config"
    "github.com/wowsoso/fabioz/proxy"
)
...
func (s *Server) handler() http.Handler {
    ...
    mux.Handle("/resource", &ui.ResourceHandler{Color: s.Color, Title: s.Title, Version: s.Version})
